...
export function AdminWarehouseDatabase({ products: initialProducts }: { products: Product[] }) {
  ...
  useEffect(() => {
    ...
    const savedProducts = localStorage.getItem('inventory_database_products_admin');
    if (savedProducts) {
      try {
  ...
  const addProduct = (newProduct: Product) => {
    ...
    localStorage.setItem('inventory_database_products_admin', JSON.stringify(updatedProducts));
  };
